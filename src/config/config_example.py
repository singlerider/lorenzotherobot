...
points_channel = "channelforpointstobeadded"#depracated line; not needed
...
config = {
        ...
        'oauth_password': 'oauth:1234567890qwertyuiop', # get this from http://twitchapps.com/tmi/
                ...
                '#channelone': {
                        ...
                        'cron_functions': [
                                (#test_cron,(pokemon_import.master_pokemon,),
                                 # Right now, can only run either cron function at a time. Cannot run both
                                 test_cronb,())
                        ]
                },
