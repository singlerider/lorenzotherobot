...
def party(args):
    ...
    if position in ['1','2','3','4','5','6']:
        ...
        return "lvl " + str(level) + " " + nickname + ": HP " + str(hp) + ", Att " + str(attack) + ", Spd " + str(speed) + ", Def " + str(defense) + ", SpAtt " + str(special_attack) + ", SpDef " + str(special_defense) + ", " + pokemon_type1 + ", " + pokemon_type2
    elif args[0] == 'members':
